...
// function change(){
os.system('clear');
echo color("red","* ANDI TIRTO \n");
echo color("red","* ANDI TIRTO \n");
echo color("white","* ANDI TIRTO \n");
echo color("white","* ANDI TIRTO \n");
echo color("green","* Time : ".date('[d-m-Y] [H:i:s]')." \n");
        ...
        echo color("green","* lebokke kode smesesmu!")."\n";
        otp:
...
*/
echo color("green","* isinen meneh nomermu : ");
...
$token = $accesstoken;
        ...
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"RAMADAN60"}');
